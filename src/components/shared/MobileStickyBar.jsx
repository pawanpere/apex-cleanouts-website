...
const MobileStickyBar = ({ onQuoteClick }) => {
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
            ...
            <div className="bg-[#0a2918] border-t border-[#22C55E]/20 px-4 py-3 flex items-center gap-3 shadow-[0_-4px_20px_rgba(0,0,0,0.3)]">
                {/* Get a Quote Button */}
                <button
                    onClick={onQuoteClick}
                    className="flex-1 bg-[#22C55E] text-[#0a2918] py-3.5 rounded-xl font-bold text-sm tracking-wide flex items-center justify-center gap-2 active:scale-95 transition-transform"
                >
